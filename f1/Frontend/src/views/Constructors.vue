            ...
            <div class="constructors-box">
              <div v-for="constructor in constructors" :key="constructor.constructorId" class="constructor">
                <div class="constructor-info">
                  <hr>
                  <div class="constructor-info-data"><strong>{{ constructor.name }}</strong></div>
                  <div class="constructor-info-mid">{{ constructor.nationality }}</div>
                  <hr>
                  <div><img :src="require(`@/Constructorspicture/${constructor.name}.png`)" alt="Constructor Logo"
